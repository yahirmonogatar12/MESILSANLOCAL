...
# Helpers _ks_current_bom_revision, _eco_for_part_revision y
# _plan_bom_revision_catalog consolidados en app/api/shared/bom_revisions.py
# (2026-05-25). Antes vivian duplicados aqui y en
