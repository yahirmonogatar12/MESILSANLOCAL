...
def buscar_material_por_numero_parte():
    ...
    try:
        ...
        query_inventario = """
            ...
            WHERE numero_parte LIKE %s OR numero_parte = %s
            ORDER BY fecha_actualizacion DESC
        """
        
        inventario_general = execute_query(query_inventario, (f'%{numero_parte}%', numero_parte), fetch='one')
        ...
        if inventario_general:
            ...
            resultados = execute_query(query_individual, (f'%{numero_parte}%', numero_parte), fetch='all') or []
