...
Rutas (con url_prefix `/api`):
  ...
  GET    /api/work_orders               -> listar WO
  GET    /api/wo/listar                 -> listar WO (ruta alternativa)
...
Migrado desde `app/api_po_wo.py` (2026-05-22). Sin cambios funcionales.
"""
...
def listar_pos():
    ...
    try:
        ...
        if result is not None:
            ...
            print(" Error en consulta de POs: No se obtuvieron resultados")
...
def crear_po():
    ...
    try:
        ...
        if affected_rows and affected_rows > 0:
            ...
            print(" Error creando PO: No se insertaron filas")
