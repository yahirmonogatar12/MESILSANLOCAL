...
material_admin_bp = Blueprint("material_admin", __name__)
...
@material_admin_bp.route("/material/inventario_actual")
@login_requerido
...
@material_admin_bp.route("/material/historial_admin/<tipo>")
@login_requerido
...
@material_admin_bp.route("/api/material_admin/inventory/summary")
@login_requerido
@requiere_permiso_material_admin("Inventario actual")
...
@material_admin_bp.route("/api/material_admin/inventory/lots")
@login_requerido
@requiere_permiso_material_admin("Inventario actual")
...
@material_admin_bp.route("/api/material_admin/inventory/export")
@login_requerido
@requiere_permiso_material_admin("Inventario actual")
...
@material_admin_bp.route("/api/material_admin/history/<tipo>")
@login_requerido
@requiere_permiso_material_admin(lambda tipo: HISTORY_PERMISSION_BY_TYPE.get(tipo))
...
@material_admin_bp.route("/api/material_admin/history/<tipo>/export")
@login_requerido
@requiere_permiso_material_admin(lambda tipo: HISTORY_PERMISSION_BY_TYPE.get(tipo))
