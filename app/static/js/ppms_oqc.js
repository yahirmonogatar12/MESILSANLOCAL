...
(function () {
  ...
  const STYLESHEET_ID = "ppms-oqc-css";
  const STYLESHEET_HREF = "/static/css/ppms_oqc.css?v=20260608d";
  const API_DATA = "/api/control_calidad/ppms/oqc";
  const API_TARGET = "/api/control_calidad/ppms/oqc/target";
  ...
  function getLqcElements(root) {
    return {
      root,
      target: root.querySelector("#ppms-oqc-target"),
      saveTarget: root.querySelector("#ppms-oqc-save-target"),
      filters: root.querySelector("#ppms-oqc-filters"),
      dateFrom: root.querySelector("#ppms-oqc-date-from"),
      dateTo: root.querySelector("#ppms-oqc-date-to"),
      groupBy: root.querySelector("#ppms-oqc-group-by"),
      line: root.querySelector("#ppms-oqc-line"),
      search: root.querySelector("#ppms-oqc-search"),
      clear: root.querySelector("#ppms-oqc-clear"),
      trendTitle: root.querySelector("#ppms-oqc-trend-title"),
      trendChart: root.querySelector("#ppms-oqc-trend-chart"),
      topPartChart: root.querySelector("#ppms-oqc-top-part-chart"),
      trendTable: root.querySelector("#ppms-oqc-trend-table"),
      topDetailTable: root.querySelector("#ppms-oqc-top-detail-table"),
      lineWeeklyTable: root.querySelector("#ppms-oqc-line-weekly-table"),
    };
  }
  ...
  function buildLqcQuery(elements) {
    ...
    if (elements.groupBy.value) params.set("group_by", elements.groupBy.value);
  ...
  function updateTrendTitle(elements, payload) {
    ...
    const stageLabel = payload.stage || "OQC";
  ...
  function inicializarPPMsOQC(root) {
    ensureStylesheet();
    const moduleRoot =
  ...
  window.inicializarPPMsOQC = inicializarPPMsOQC;
  document.querySelectorAll("#ppms-oqc-module").forEach(inicializarPPMsOQC);
})();
