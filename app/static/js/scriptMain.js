...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.mostrarControlAlmacen = function () {
    ...
    setTimeout(() => {
      ...
      if (typeof window.inicializarControlAlmacenModule === "function") {
        ...
        console.warn(
          " inicializarControlAlmacenModule no disponible, intentando métodos individuales",
        );
        ...
        if (typeof window.inicializarControlAlmacen === "function") {
          ...
          console.warn(
            " inicializarControlAlmacen no disponible, usando métodos individuales",
          );
  ...
  window.mostrarControlSalida = function () {
    ...
    setTimeout(() => {
      ...
      if (typeof window.inicializarControlSalidaModule === "function") {
        ...
        console.warn(
          " inicializarControlSalidaModule no disponible, intentando métodos individuales",
        );
  ...
  window.mostrarControlRetorno = async function () {
    ...
    if (window.AjaxContentManager) {
      await AjaxContentManager.loadContent(
        "/material/control_retorno",
        "#control-retorno-container",
      );
    } else {
