...
# -*- coding: utf-8 -*-
"""
Test para verificar los cambios en el layout de la etiqueta:
- Texto movido hacia arriba
- Eliminadas etiquetas "Lote:" y "Parte:" 
- Solo se muestra la cantidad actual sin etiqueta "Cantidad:"
"""
...
def test_layout_optimizado():
    print('📐 === TEST LAYOUT OPTIMIZADO ===')
    
    # Código de prueba
    codigo = f'TEST-LAYOUT-OPT-{datetime.now().strftime("%Y%m%d%H%M%S")}'
    ...
    # Generar comando ZPL con layout optimizado
...
^FT160,125^A0N,14,14^FH\\^CI28^FD{datos_simulados['cantidadActual']} Prop: {datos_simulados['propiedad']}^FS^CI27
^FT164,146^A0N,17,18^FH\\^CI28^FDHora: {datetime.now().strftime('%H:%M:%S')}^FS^CI27
^PQ1,0,1,Y
^XZ"""

    print('\n📐 === ANÁLISIS DE LOS CAMBIOS ===')
    print('✅ CAMBIOS REALIZADOS:')
    print('   • Texto movido hacia arriba:')
    print('     - Título: Y=25 → Y=20 (5 puntos arriba)')
    print('     - Etiqueta: Y=46 → Y=41 (5 puntos arriba)')
    print('     - Código: Y=67 → Y=62 (5 puntos arriba)')
    print('     - Fecha: Y=88 → Y=83 (5 puntos arriba)')
    print('     - Lote/Parte: Y=109 → Y=104 (5 puntos arriba)')
    print('     - Cantidad: Y=130 → Y=125 (5 puntos arriba)')
    print('     - Hora: Y=151 → Y=146 (5 puntos arriba)')
    print('   • Eliminadas etiquetas "Lote:" y "Parte:"')
    print('   • Eliminada etiqueta "Cantidad:"')
    print('   • QR se mantiene en posición óptima')
    
    print('\n📊 NUEVO LAYOUT:')
    print('   ┌─────────────────────────────────────────────────┐')
    print('   │ QR   ILSAN ELECTRONICS MES                      │')
    print('   │ ██   Codigo de material recibido:               │') 
    print('   │ ██   TEST-LAYOUT-OPT-20250716...                │')
    print('   │ ██   Fecha de entrada: 16/07/2025               │')
    print('   │ ██   L2025001 P12345                            │')  # Sin etiquetas
    print('   │      100 Prop: RESISTOR                         │')  # Sin "Cantidad:"
    print('   │      Hora: 14:30:25                             │')
    print('   └─────────────────────────────────────────────────┘')
    
    print('\n📏 VENTAJAS DEL NUEVO LAYOUT:')
    print('   ✅ Más compacto y limpio')
    print('   ✅ Eliminación de texto redundante')
    print('   ✅ Mejor aprovechamiento del espacio')
    print('   ✅ Información más directa y clara')
    print('   ✅ Lote y parte juntos en una línea')
    print('   ✅ Cantidad más prominente sin etiqueta')
    
    print('\n🔄 COMPARACIÓN ANTES/DESPUÉS:')
    print('   ANTES: "Lote: L2025001 Parte: P12345"')
    print('   DESPUÉS: "L2025001 P12345"')
    print('   ')
    print('   ANTES: "Cantidad: 100 Prop: RESISTOR"')
    print('   DESPUÉS: "100 Prop: RESISTOR"')
    ...
    print('\n🎯 RESULTADO:')
    print('✅ Texto movido 5 puntos hacia arriba en todas las líneas')
    print('✅ Eliminadas etiquetas "Lote:" y "Parte:"') 
    print('✅ Eliminada etiqueta "Cantidad:"')
    print('✅ Layout más limpio y compacto')
    print('✅ Comando ZPL listo para impresión')
    
    return comando_zpl

if __name__ == '__main__':
    test_layout_optimizado()
